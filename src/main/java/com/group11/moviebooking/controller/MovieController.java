...
public class MovieController {
    ...
    public ModelAndView showMovies(HttpSession session, Model model) {
        ...
        ArrayList<MovieEntity> moviesBannerSlide = this.movieService.getallMoviesLimit(4);
        ArrayList<MovieEntity> RecentMovies = this.movieService.getallMoviesLimit(9);
        List<MovieEntity> PopularMovies = this.movieService.getallMoviesLimit(12);
