...
public class CustomerController {
    ...
    public CustomerController(AdminService adminService, CustomerService customerService, MovieService movieService) {
    ...
    public String getHomePage(Model model) {
        ArrayList<MovieEntity> movies = this.movieService.getallMoviesLimit(4);
