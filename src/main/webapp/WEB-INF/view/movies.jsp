		...
		<div class="grids-main py-5">
			<div class="container py-lg-4">
				...
				<div class="w3l-populohny-grids">
					...
					<c:forEach items="${adultMovies}" var="movie" begin="0" end="3">
						<div class="item vhny-grid">
							<div class="box16 mb-0">
								<figure>
									<img class="img-fluid" src="${movie.movie_poster_url}" alt="">
				...
				<div class="w3l-populohny-grids">
					<c:forEach items="${kidMovies}" var="movie" begin="0" end="3">
						<div class="item vhny-grid">
							<div class="box16 mb-0">
								<figure>
									<img class="img-fluid" src="${movie.movie_poster_url}" alt="">
				...
				<div class="w3l-title-grids">
					<div class="headerhny-left">
						<h3 class="hny-title">Top Rating</h3>
					</div>
					<div class="headerhny-right text-lg-right">
						<h4><a class="show-title" href="/movies">Show all</a></h4>
					</div>
				...
				<div class="w3l-populohny-grids">
					<c:forEach items="${ratingMovies}" var="movie" begin="0" end="3">
						<div class="item vhny-grid">
							<div class="box16 mb-0">
								<figure>
									<img class="img-fluid" src="${movie.movie_poster_url}" alt="">
