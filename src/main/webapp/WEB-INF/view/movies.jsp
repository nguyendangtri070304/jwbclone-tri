						...
						<div class="w3l-populohny-grids">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/commando3.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<p>
														...
														the commando Karan, who goes undercover with encounter
														specialist
												...
												<div class="bookbtn">
													<button type="button" class="btn btn-success"
														onclick="location.href='/ticket-booking';">Book</button>
												</div>
											</div>
										</div>
									</div>
											...
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<p>
														...
														dysfunctional family. The film features an ensemble cast
														including
														Daniel Craig, Chris Evans, Ana de Armas, Jamie Lee Curtis,
														Michael
														Shannon, Don Johnson, Toni Collette, Lakeith Stanfield,
														Katherine
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade Bharat" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/bharat1.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<p>
														...
														directed
														by Ali Abbas Zafar. It is jointly produced by Atul Agnihotri,
														Alvira
														Khan Agnihotri, Bhushan Kumar, Krishan Kumar, Nikhil Namit and
														Salman
														Khan under the banners Reel Life Productions, Salman Khan Films
														and
														T-Series. The film stars Salman Khan, Katrina Kaif, Sunil
														Grover, Disha
														Patani and Jackie Shroff. Tabu makes a friendly appearance. It
														traces
														India's post-independence history from the perspective of a
														common man,
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade Jumanji" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<p>
														...
														comedy film
														directed by Jake Kasdan and co-written by Kasdan, Jeff Pinkner,
														and
														Scott Rosenberg. It is a sequel to 2017's Jumanji: Welcome to
														the
														Jungle, the second follow-up to 1995's Jumanji, and is the
														fourth
														installment in the Jumanji franchise. It stars Dwayne Johnson,
														Jack
														Black, Kevin Hart, Karen Gillan, Nick Jonas, Alex Wolff, Morgan
														Turner,
														Ser'Darius Blain, and Madison Iseman reprising their roles from
														the
														previous film while Awkwafina, Rory McCann, Danny Glover, and
														Danny
														DeVito also join the cast. The film's plot takes place two years
														after
														Welcome to the Jungle, in which the same group of teenagers,
														along with
														an old friend and two unwitting additions, become trapped in
														Jumanji.
														There, they all find themselves facing new problems and
														challenges with
														both old and new avatars while having to save the land from a
														new
						...
						<div class="w3l-populohny-grids">
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<h4>About Movie</h4>
													<p>
														Rocketman is a 2019 biographical musical film based on the life
														of
														British musician Elton John. Directed by Dexter Fletcher and
														written by
														Lee Hall, it stars Taron Egerton as Elton John, with Jamie Bell
														as
														Bernie Taupin, Richard Madden as John Reid, and Bryce Dallas
														Howard as
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<h4>About Movie</h4>
													<p>
														Doctor Sleep is a 2019 American supernatural horror film written
														and
														directed by Mike Flanagan. It is based on the 2013 novel of the
														same
														name by Stephen King, a sequel to King's 1977 novel The Shining.
														The
														film, which also serves as a direct sequel to the 1980 film
														adaptation
														of The Shining, directed by Stanley Kubrick, is set several
														decades
														after the events of the original and combines elements of the
														1977 novel
														as well. Ewan McGregor plays the lead role as Danny Torrance, a
														man with
														psychic abilities who struggles with childhood trauma. Rebecca
														Ferguson,
														Kyliegh Curran, and Cliff Curtis have supporting roles.[6][7] In
														the
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade kabir" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/ks1.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<p>
														...
														written
														and directed by Sandeep Reddy Vanga and jointly produced by
														Bhushan
														Kumar, Murad Khetani, Krishan Kumar Ashwin Varde and co-produced
														by
														Vinod Bhanushali under T-Series Films and Cine1 Studios. A
														remake of
														Vanga's own Telugu film Arjun Reddy (2017), it stars Shahid
														Kapoor in
														the titular role as a surgeon who spirals into self-destruction
														when his
														girlfriend, Preeti, played by Kiara Advani, marries someone
														else. Adil
														Hussain, Nikita Dutta, Arjan Bajwa, Suresh Oberoi, Dolly Minhas,
														Suparna
														Marwah, Anurag Arora, Soham Majumdar, Kunal Thakur, Anusha
														Sampath, Amit
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade Joker" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<p>
														...
														and
														produced by Todd Phillips, who co-wrote the screenplay with
														Scott
														...
														violent
														counter-cultural revolution against the wealthy in a decaying
														Gotham
														City. Robert De Niro, Zazie Beetz, Frances Conroy, Brett Cullen,
														Glenn
														Fleshler, Bill Camp, Shea Whigham, and Marc Maron appear in
														supporting
														roles. Joker was produced by Warner Bros. Pictures, DC Films,
														and Joint
						...
						<div class="w3l-populohny-grids">
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade tzp" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/tzp.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<h4>About Movie</h4>
													<p>
														Taare Zameen Par (titled Little Stars on Earth internationally)
														is a
														2007 Indian Hindi-language drama film produced and directed by
														Aamir
														...
														overcome
														his reading disorder. Darsheel Safary stars as 8-year-old
														Ishaan, and
											...
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<p>
														...
														film directed by Nitesh Tiwari and Vikas Bahl and produced by
														Ronnie
														Screwvala under UTV Motion Pictures and Salman Khan under his
														SKBH
														...
														Ranbir
														Kapoor in an item-number.Chillar Party won the 2011 National
														Film
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade ganesha" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/ganesha.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<h4>About Movie</h4>
													<p>
														My Friend Ganesha is a 2008 Indian Hindi-language film written
														and
														directed by Rajiv S Ruia and produced by Deepak Bhanushali,
														Manish
											...
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<p>
														...
														produced by
														Pixar Animation Studios and released by Walt Disney Pictures. It
														is the
														...
														feature
														directorial debut) from a screenplay by Andrew Stanton and
														Stephany
														Folsom; the three also conceived the story alongside John
														Lasseter,
														Rashida Jones, Will McCormack, Valerie LaPointe, and Martin
														Hynes.
														Tom Hanks, Tim Allen, Annie Potts, Joan Cusack, Don Rickles (via
														archive
														recordings),Wallace Shawn, John Ratzenberger, Estelle Harris,
														Blake
														Clark, Bonnie Hunt, Jeff Garlin, Kristen Schaal and Timothy
														Dalton
														reprise their character roles from the first three films. They
														are
						...
						<div class="w3l-populohny-grids">
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade gk" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													...
													<h4>About Movie</h4>
													<p>
														Golkeri (Mango pickle) is a Gujarati comedy drama film directed
														by Viral
														Shah and produced by Manasi Parekh and Parthiv Gohil under
														banner of
														Soul Sutra Studio. It is written by Viral Shah and Amatya. The
														film
														starring Malhar Thakar and Manasi Parekh is a remake of 2017
														Marathi
														film Muramba
													</p>
													<h4>Star Cast</h4>
									...
									<div class="modal fade gujjubhai" id="myModal" tabindex="-1" role="dialog"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/gujjubhai.jpeg" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<h4>About Movie</h4>
													<p>
														Gujjubhai The Great (Gujarati: ગુજ્જુભાઈ ધ ગ્રેટ) is a 2015
														Gujarati
														comedy film directed by Ishaan Randeria. It is presented by
														Nakshatra
														Entertainment and produced by Devendra N. Patel in association
														with
														Siddharth Randeria Productions. The film is a comedy drama based
														on the
														super-hit franchise of Gujjubhai stage-plays. The film stars
														Siddharth
														Randeria, Jimit Trivedi, Swati Shah, Dipna Patel, Alekh Sangal,
														Sunil
														Vishrani, Khatera Hakimi and Dharmesh Vyas. The film released on
														18
														September.
													</p>
													<h4>Star Cast</h4>
									...
									<div class="modal fade thaijase" id="myModal" tabindex="-1" role="dialog"
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/Thaijase.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<h4>About Movie</h4>
													<p>
														Thai Jashe! (English: Will Be Done!) is a 2016 Indian Gujarati
														film
														written and directed by Nirav Barot.It is about the struggles of
														a middle class man to achieve his goals in the metrocity
														Ahmedabad. The
														film stars Manoj Joshi,Malhar Thakar, and Monal Gajjar. The film
														was
							...
							<div class="item vhny-grid">
								<div class="box16 mb-0">
									...
									<!-- Modal -->
									<div class="modal fade Reva" id="myModal" tabindex="-1" role="dialog"
										aria-hidden="true">
										<div class="modal-dialog" role="document">
											<div class="modal-content" id="mymodalcontent">
												<div class="modal-header">
												...
												<div class="modal-body" id="dynamic-content">
													<img src="assets/images/reva.png" class="img-fluid modalimg"
														alt="" />
													<p>
													...
													<p>
														...
														Gujarati novel Tatvamasi. The film was directed by Rahul Bhole
														and Vinit
														Kanojia. It was released on 6 April 2018 to highly positive
														critic
														reviews praising performances of cast, story and cinematography
														and
														positive commercial acclaim too. The film won National Film
														Award for
