...
<div class="container_signup_signin" id="container_signup_signin">
	<div class="form-container sign-up-container">
		<form:form method="post" name="sign-up-form" action="/register" onsubmit="return signUpValidateForm()"
			...
			<form:input path="customer_password" name="sign-up-passwd" type="password"
