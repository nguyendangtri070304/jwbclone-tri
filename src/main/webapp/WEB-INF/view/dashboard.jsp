  ...
  <div class="card top-selling overflow-auto">
    ...
    <div class="card-body pb-0">
      ...
      <table class="table table-borderless">
        ...
        <tbody>
          <tr>
            <th scope="row"><a href="#"><img src="assets/images/s-l400.jpeg" alt="" title="Avatar: The Way of Water" style="width: 50px;"></a></th>
            <td><a href="#" class="text-primary fw-bold">Avatar: The Way of Water</a></td>
            <td>$12</td>
            <td class="fw-bold">1,200</td>
            <td>$14,400</td>
          </tr>
          <tr>
            <th scope="row"><a href="#"><img src="assets/images/s-l500.jpeg" alt="" title="Spider-Man: No Way Home" style="width: 50px;"></a></th>
            <td><a href="#" class="text-primary fw-bold">Spider-Man: No Way Home</a></td>
            <td>$10</td>
            <td class="fw-bold">950</td>
            <td>$9,500</td>
          </tr>
          <tr>
            <th scope="row"><a href="#"><img src="assets/images/s-I600.jpeg" alt="" title="The Batman" style="width: 50px;"></a></th>
            <td><a href="#" class="text-primary fw-bold">The Batman</a></td>
            <td>$11</td>
            <td class="fw-bold">850</td>
            <td>$9,350</td>
          </tr>
          <tr>
            <th scope="row"><a href="#"><img src="assets/images/s-I700.jpeg" alt="" title="Black Panther: Wakanda Forever" style="width: 50px;"></a></th>
            <td><a href="#" class="text-primary fw-bold">Black Panther: Wakanda Forever</a></td>
            <td>$13</td>
            <td class="fw-bold">730</td>
            <td>$9,490</td>
          </tr>
          <tr>
            <th scope="row"><a href="#"><img src="assets/images/s-I800.jpeg" alt="" title="Doctor Strange in the Multiverse of Madness" style="width: 50px;"></a></th>
            <td><a href="#" class="text-primary fw-bold">Doctor Strange in the Multiverse of Madness</a></td>
            <td>$12</td>
            <td class="fw-bold">680</td>
            <td>$8,160</td>
          </tr>
        </tbody>
      </table>
  ...
  <div class="card-body">
    ...
    <div class="activity">
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          Failed payment for <a href="#" class="fw-bold text-primary">"Black Panther: Wakanda Forever"</a>
        </div>
      </div><!-- End activity item -->
      ...
      <div class="activity-item d-flex">
        ...
        <div class="activity-content">
          ...
          <a href="#" class="fw-bold text-primary">"Doctor Strange in the Multiverse of Madness"</a>
        </div>
      </div><!-- End activity item -->
  ...
  <div class="card-body pb-0">
    ...
    <div class="news">
      ...
      <div class="post-item clearfix">
        ...
        <p>The movie has grossed over $2 billion worldwide, making it one of the highest-grossing films...</p>
      </div>
      ...
      <div class="post-item clearfix">
        ...
        <p>The much-anticipated sequel to "The Batman" has released its first trailer, teasing fans with...</p>
      </div>
      ...
      <div class="post-item clearfix">
        ...
        <p>Check out our curated list of the best movies to watch this November, including "The Marvels"...</p>
      </div>
